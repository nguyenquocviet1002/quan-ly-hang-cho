...
import styles from './ClinicListEdit.module.scss';

function ClinicListEdit() {
  const clinicList = clsx(styles.clinicList);
  const clinicBox = clsx(styles.clinicBox);
  const clinicEdit = clsx(styles.clinicEdit);
  const clinicEditForm = clsx(styles.clinicEditForm);
  ...
  return (
    <div className="container">
      <div className={clinicBox}>
        ...
        <div className={clinicEdit}>
          <h2>Sửa phòng khám</h2>
          <div className={clinicEditForm}>
